...
BEGIN
	...
	BEGIN
		INSERT INTO [Employees] ([EmployeeCode], [Name], [Email], [Designation], [JoiningDate],[PermanentAddress],[CommunicationAddress]) 
			VALUES ('CR-001', 'Anuj Shukla','anuj.shukla@crowe.com','Manager', '05-02-2020','Bhagat Colony Gali No 14', 'Phone: 798****47');
	END

	IF NOT EXISTS (SELECT 1 FROM [Employees] WHERE [EmployeeCode] = 'CR-002')
	BEGIN
		INSERT INTO [Employees] ([EmployeeCode], [Name], [Email], [Designation], [JoiningDate],[PermanentAddress],[CommunicationAddress]) 
			VALUES ('CR-002', 'Mukund Kumar','mukund.kumar@crowe.com','Manager', '05-02-2020','Bhagat Colony Gali No 14', 'Phone: 798****47');
	END
	IF NOT EXISTS (SELECT 1 FROM [Employees] WHERE [EmployeeCode] = 'CR-003')
	BEGIN
		INSERT INTO [Employees] ([EmployeeCode], [Name], [Email], [Designation], [JoiningDate],[PermanentAddress],[CommunicationAddress]) 
			VALUES ('CR-003', 'Arun Yadav','arun.yadav@crowe.com','Manager', '05-02-2020','Bhagat Colony Gali No 14', 'Phone: 798****47');
	END
	IF NOT EXISTS (SELECT 1 FROM [Employees] WHERE [EmployeeCode] = 'CR-004')
	BEGIN
		INSERT INTO [Employees] ([EmployeeCode], [Name], [Email], [Designation], [JoiningDate],[PermanentAddress],[CommunicationAddress]) 
			VALUES ('CR-004', 'Sachin Tekchandani','sachin.tekchandani@crowe.com','Manager', '05-02-2020','Bhagat Colony Gali No 14', 'Phone: 798****47');
	END
END